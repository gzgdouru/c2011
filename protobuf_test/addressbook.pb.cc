...
void protobuf_AssignDesc_addressbook_2eproto() {
  ...
  static const int AddressBook_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AddressBook, person_info_),
  };
...
void protobuf_AddDesc_addressbook_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "rson_info\030\001 \003(\0132\023.addressbook.Person", 316);
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (tag == 10) {
         parse_person_info:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
                input, add_person_info()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(10)) goto parse_person_info;
        if (input->ExpectAtEnd()) goto success;
        break;
      }
...
void AddressBook::SerializeWithCachedSizes(
  ...
  // repeated .addressbook.Person person_info = 1;
  for (int i = 0; i < this->person_info_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->person_info(i), output);
  }
...
int AddressBook::ByteSize() const {
  ...
  // repeated .addressbook.Person person_info = 1;
  total_size += 1 * this->person_info_size();
  for (int i = 0; i < this->person_info_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->person_info(i));
...
bool AddressBook::IsInitialized() const {
  ...
  if (!::google::protobuf::internal::AllAreInitialized(this->person_info())) return false;
  return true;
}

void AddressBook::Swap(AddressBook* other) {
  if (other != this) {
    person_info_.Swap(&other->person_info_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
